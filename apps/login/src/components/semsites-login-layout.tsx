...
export function SemsitesLoginLayout({ branding, hasLeftRightStructure, leftContent, rightContent }: Props) {
  ...
  const shellClass = isFullSplit
    ? "grid min-h-screen overflow-hidden bg-white dark:bg-[#0b1115] md:grid-cols-[0.92fr_1.08fr]"
    : "grid min-h-[640px] w-full overflow-hidden rounded-[2rem] border border-black/10 bg-white shadow-2xl shadow-slate-950/10 dark:border-white/10 dark:bg-[#0b1115] md:grid-cols-[0.92fr_1.08fr]";
  ...
  const formSectionClass = isFullSplit
    ? "flex min-h-[320px] items-center justify-center bg-[#f7f6f0] px-8 py-16 dark:bg-[#0f171c] md:min-h-screen"
    : "flex min-h-[320px] items-center justify-center bg-[#f7f6f0] p-10 dark:bg-[#0f171c] md:min-h-[640px]";
